    ...
    <div className="min-h-screen" style={{ backgroundColor: "#F6F4EF", color: "#1c1917" }}>
      ...
      <header className="px-6 py-5 max-w-6xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-md bg-[#b85c1e] flex items-center justify-center text-white text-sm font-bold">F</div>
          <div className="text-xl font-bold tracking-tight" style={serif}>FleetFinder</div>
        </div>
      ...
      <footer className="px-6 py-10 border-t border-stone-200">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-stone-500">
          <div style={serif} className="font-bold text-stone-800">FleetFinder <span className="font-sans font-normal text-stone-500">· by RHD Reality Group</span></div>
