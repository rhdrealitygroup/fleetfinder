...
// Reads the prebuilt catalog (pulled from MarketCheck /dealers/car) and filters
// by query / state / type, sorted by inventory size (most active first).
